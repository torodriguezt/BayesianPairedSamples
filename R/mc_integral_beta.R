...
mc_integral_beta <- function(k, x1, x2, n1, n2, alpha0, alpha1, alpha2, j, N1, N2, n_bootstrap, seed = NULL) {

  i <- seq(1, N1)

  MC1 <- tryCatch({
    mean(sapply(i, function(i_val) {
      error_two(x1 = x1, x2 = x2, n1 = n1, n2 = n2, alpha0 = alpha0, alpha1 = alpha1, alpha2 = alpha2,
                i = i_val, j = j, N2 = N2, n_bootstrap = n_bootstrap, k = k, seed = seed)
    }), na.rm = TRUE)
  }, error = function(e) {

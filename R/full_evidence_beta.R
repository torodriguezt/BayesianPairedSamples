...
#'
#' This function calculates the evidence (`beta_results_all_grids`) for multiple grids of values `k`
...
#'
#' @export
full_evidence_beta <- function(x1, x2, n1, n2, alpha0, alpha1, alpha2, N1, N2, n_bootstrap, seed = NULL) {
    ...
    future_map_dbl(
      ...
      ~{
        ...
        results <- sapply(j, function(current_j) {
          mc_integral_beta(k = .x, x1 = x1, x2 = x2, n1 = n1, n2 = n2,
